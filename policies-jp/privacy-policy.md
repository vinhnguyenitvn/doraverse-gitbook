...
* **登録所在地：**
* **代表取締役：**
* **お問い合わせ先：**[ 第14条（お問い合わせ）](privacy-policy.md#id-14-oiwase)をご参照ください。
...
* 研究開発：
  ...
  * 当社は、本サービス全般を改善するために、限定的な研究開発目的で、匿名化および集計化されたユーザー情報を利用することがあります。詳細については、[第6条（AI固有のデータ取扱い）](privacy-policy.md#id-6-ainodtai)および当社の [「AIデータ利用ポリシー」](broken-reference) をご参照ください。
...
* 第三者のAIモデル：一部の機能は、第三者のAIモデルを利用する場合があります。当社はこれらの機能を特定し、お客様のデータはそれらのプロバイダーの規約およびプライバシーポリシーの対象となります。\
  AIモデル入力用データ、AIモデル訓練および改善用データ、第三者のAIモデルによって処理されるデータ、およびお客様の責任を含む、当社のAI機能に関連するデータの取扱いに関する詳細については、当社の専用の [「AIデータ利用ポリシー」](https://app.gitbook.com/o/tAGhrRUfoEEnrkhlp8FA/s/fsOWSxMmR202Vh1idLny/~/changes/6/ai-data-usage-policy-international)をご参照ください。
...
* 第三者提供記録の開示。\
  これらの権利を行使するには、当社の「個人情報お問い合わせ窓口」[（第14条参照）](privacy-policy.md#id-14-oiwase)にご連絡ください。当社はお客様の身元を確認し、個人情報保護法に従って対応しますが、場合によっては手数料が発生したり、制限が存在したりする可能性があることにご留意ください。
...
本プライバシーポリシー、当社のデータ取扱い慣行に関するご質問、懸念、苦情、または[第10条](privacy-policy.md#id-10-ononisuruononidzuku)に記載されているお客様の個人情報に関するお客様の権利の行使をご希望の場合は、当社の指定する「個人情報お問い合わせ窓口」まで、以下の方法でご連絡ください。

* **電子メール：**
* **郵送先住所：**&#x44;oraverse Inc.\
  個人情報お問い合わせ窓口／個人情報保護管理者 宛
* **個人情報保護管理者：**&#x20;

お客様の要求を効率的に処理するために、お名前、連絡先、およびお問い合わせまたは要求内容の明確な説明をご提供ください。
