...
2. 利用者から当社への通知は、[support@doraverse.ai](mailto:support@doraverse.ai) への電子メール送信、又は当社が指定するその他の手段により行うものとします。
...
* 本店所在地： `[登記上の本店住所]`
* 電話番号： `[カスタマーサポート電話番号]`
* 電子メールアドレス： [support@doraverse.ai](mailto:support@doraverse.ai)
