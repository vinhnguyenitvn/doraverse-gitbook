...
Doraverse can be installed as a Progressive Web App (PWA) — giving you an app-like experience, right from your browser. No downloads, no hassle.

Follow the steps below to install Doraverse on your Desktop or Mobile device.
...
1. Open browser on your device and visit your Doraverse workspace URL.
2. Tap the **Share** icon (bottom of screen).
3. Scroll down and tap **Add to Home Screen**.
4. Tap **Add** on the top right.

<figure><img src="../.gitbook/assets/iOS install_Doraverse.png" alt=""><figcaption></figcaption></figure>
...
3. You **two options** under “**Add to home screen**”:
   1. **Install**\
      ...
      It behaves like a standalone app with a full-screen experience.\
      Recommended if you want the full app-like functionality.&#x20;
   2. **Create shortcut**\
      ➤ This adds a home screen shortcut, but it opens in a browser tab.\
      Good for quick access without full installation.
